...
- **Chrome_MondaryNewTab** — [🇫🇷 FR](README.md) (`../../Chrome_MondaryNewTab`) ✳️ dirty
- **Chrome_PKchromeShortcuts** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../Chrome_PKchromeShortcuts`) ✳️ dirty
- **Chrome_pkhighlighter** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../Chrome_pkhighlighter`) ✳️ dirty
...
- **VS_pkscriptcat_snippets** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../VS_pkscriptcat_snippets`) ✳️ dirty
- **VS_pkterminal** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../VS_pkterminal`) ✳️ dirty
- **VS_pkvsconf** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../VS_pkvsconf`) ✳️ dirty

## WEB

- **Web_about** — Description non disponible. (`../../Web_about`) ⚠️ no desc ⚠️ no icon.png ⚠️ no git
- **Web_allaitement** — Simple breastfeeding timer with session tracking and charts. (`../../Web_allaitement`) ⚠️ no icon.png ✳️ dirty
- **Web_BGAcss** — The BGA site is pretty old school and sometimes just unclear! This is an attempt to improve it a little using only CSS. (`../../Web_BGAcss`) ⚠️ no icon.png ✳️ dirty
...
- **Web_cv** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../Web_cv`) ✳️ dirty
- **Web_GGdeals_collection** — [🇫🇷 FR](README.md) · [🇬🇧 EN](README_en.md) (`../../Web_GGdeals_collection`) ✳️ dirty
...
- **Web_pkchangedetection** — Application PHP simple pour surveiller les changements de pages web. (`../../Web_pkchangedetection`)
